...
<a class="kembali" href="tambah1.php">Tambah Customer </a>|<a class="kembali" href="../home.php">Kembali</a>
    ...
    <tr>
        <?php
            ...
            while ($data=mysqli_fetch_array($query)){
                ...
                <td>
				<a class="edit" href="ubah1.php?NPWP_Customer=<?php echo $data['NPWP_Customer'];?>" >Edit</a> |
